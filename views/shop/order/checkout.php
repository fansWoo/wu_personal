		...
		<div class="cardTable">
			...
			<div class="stage">
				<div class="floatright">
					...
					（含運費 NT$ <?=$OrderShop->pay_price_freight_Num?>
			...
			<div class="stage">
				<div class="floatright"><input type="text" id="receive_name_Str" name="receive_name_Str" value=" <?=$UserFieldShop->receive_name_Str?>"></div>
				<div class="floatleft">收件人姓名</div>
			</div>
			<div class="stage">
				<div class="floatright long"><input type="text" id="receive_address_Str" name="receive_address_Str" value=" <?=$UserFieldShop->receive_address_Str?>" ></div>
				<div class="floatleft">寄件地址</div>
			</div>
			<div class="stage">
				<div class="floatright"><input type="text" id="receive_phone_Str" name="receive_phone_Str" value=" <?=$UserFieldShop->receive_phone_Str?>"></div>
