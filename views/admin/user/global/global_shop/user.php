...
<div class="contentBox allWidth">
    ...
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width200">
                <input type="text" class="text" name="receive_name_Str" placeholder="請輸入收件人姓名" value="<?=$user_UserFieldShop->receive_name_Str?>" required>
            </div>
        </div>
    </div>
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width200">
                <input type="text" class="text" name="receive_phone_Str" placeholder="請輸入收件人電話" value="<?=$user_UserFieldShop->receive_phone_Str?>" required>
            </div>
        </div>
    </div>
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width200">
                <input type="text" class="text" name="receive_address_Str" placeholder="請輸入收件人地址" value="<?=$user_UserFieldShop->receive_address_Str?>" required>
            </div>
        </div>
    </div>
    <div class="spanLine spanSubmit">
