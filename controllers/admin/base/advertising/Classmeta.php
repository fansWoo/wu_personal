...
class Classmeta_Controller extends MY_Controller {
    ...
    public function edit_post()
    {
        ...
        $this->form_validation->set_rules('classname_Str', '分類名稱', 'required');
    ...
    public function tablelist()
    {
        ...
        $data['class_links'] = $data['AdvertisingClassList']->create_links(['base_url_Str' => 'admin/'.$data['child1_name_Str'].'/'.$data['child2_name_Str'].'/'.$data['child3_name_Str'].'/'.$data['child4_name_Str']]);
